...
public class TelegramCommandMatcher {
    ...
    public boolean looksLikeEditMessage(String messageText) {
        ...
        return lower.contains("muda valor")
                ...
                || lower.contains("parcela paga")
                || lower.contains("ja paguei")
                || lower.contains("estou pagando")
                || lower.contains("parcela atual")
                || lower.contains("muda a parcela")
                || lower.contains("muda parcela")
                || lower.contains("altera a parcela")
                || lower.contains("altera parcela")
                || lower.contains("troca a parcela")
                || lower.contains("troca parcela")
                || lower.contains("muda para a parcela")
                || lower.contains("muda pra parcela")
                || lower.contains("altera para a parcela")
                || lower.contains("altera pra parcela")
                || lower.contains("troca para a parcela")
                || lower.contains("troca pra parcela")
